        ...
        <div class="col-lg-2 grid-margin stretch-card offset-2">
            <div class="card" style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item"><a href="{{url('/users/register')}}" class="btn btn-outline-success btn-fw">Update User</a></li>
                ...
                <div class="card-body">
                    ...
                    <form class="form" action="#" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control" name="fname" value="{{$users->name}}"  autofocus>
                        </div>
