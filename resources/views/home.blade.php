        ...
        <div class="col-lg-8 grid-margin d-flex flex-column">
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            <div class="text-primary mb-4">
                                ...
                                <p class="font-weight-medium mt-2">Tax Payers</p>
                            </div>
                            <h1 class="font-weight-light"> &#x20A6 </h1>
                            <p class="text-muted mb-0">{{date("jS F Y", time())}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body text-center">
                            <div class="text-danger mb-4">
                                ...
                                <p class="font-weight-medium mt-2">Registered Businesses</p>
                            </div>
                            <h1 class="font-weight-light"> &#x20A6 </h1>
                            <p class="text-muted mb-0">{{date("jS F Y", time())}}</p>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            <div class="text-info mb-4">
                                <i class="fa fa-users fa-2x"></i>
                                <p class="font-weight-medium mt-2">Clients</p>
                            </div>
                            <h1 class="font-weight-light"></h1>
                            <p class="text-muted mb-0">Clients count</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row flex-grow-1">
                <div class="col-lg-6 grid-margin grid-margin-lg-0 stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Tax Payment Reports</h4>
                    ...
                    <div class="card">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <div class="d-flex justify-content-between align-items-start">
                                <h4 class="card-title">Service Transaction Reports</h4>
                                <!----
                                <div class="dropdown">
                                   <button class="btn btn-sm btn-outline-secondary btn-rounded text-black" type="button" id="dropdownMenuButton2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                      This week
                                   </button>
        ...
        <div class="col-lg-4 grid-margin stretch-card">
            <div class="card d-flex flex-column justify-content-between">
                <div class="card-body">
                    ...
                    <h4 class="font-weight-light">{{date('F, Y')}}</h4>
                    <h1 class="font-weight-normal mb-0 text-info"> &#x20A6</h1>
                    <div class="d-md-flex justify-content-start mt-5">
                        <div class="mb-3 mb-lg-0">
                            <h5 class="font-weight-light text-primary">&#x20A6 </h5>
                            <p class="text-primary mb-0">Vehicle</p>
                        </div>
                        <div class="mb-3 mb-lg-0 ml-md-4">
                            <h5 class="font-weight-light text-danger">&#x20A6 </h5>
                            <p class="text-danger mb-0">Client</p>
                        </div>
                        <!----
                           <div class="ml-md-4">
                              <h5 class="font-weight-light text-info">+23.6%</h5>
